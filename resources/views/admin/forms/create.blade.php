            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                           <div class="col-lg-offset-2 col-lg-10" id="questions"></div>
                        </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            document.getElementById('addField').addEventListener('click', function(e) {
                form.appendChild(document.createElement('div')).innerHTML = "<input type=\"text\" placeholder=\"Enter question\" required class=\"form-control\" id=\"field" + (++j) +"\" name=\"field" + (j) + "\"> </br>";
                document.getElementById('size').value = j;
            });
        });
    </script>
@endsection