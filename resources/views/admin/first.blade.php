...
<div class="ibox float-e-margins">
  ...
  <table class = "table table-hover">
   ...
   <tbody>
      ...
      @foreach ($values->all()->where('type', 'text') as $value)
      <tr>
         <td>{{ $value->id }}</td>
         <td>{{ $value->value }}</td>
     ...
     {!! Form::open(array(
        ...
        <div class="form-group">
          <div class="col-lg-offset-2 col-lg-10">
            <button class="btn btn-primary btn-circle" type="button" data-toggle="modal" data-target="#addutmtext">
    ...
    {!! Form::close() !!}
    <div class="modal inmodal" id="addutmtext" tabindex="-1" role="dialog" aria-hidden="true">
           ...
           <div class="modal-content animated bounceInRight">
                   ...
                   <div class="modal-body">
                     {!! Form::open(array(
                      ...
                      <input class="hidden" name="type" value="text">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-lg-offset-2 col-lg-10">
                              <label class="btn btn-success btn-file">
                                    Browse main image <input type="file" name="value" style="display: none;" >
                                </label>
                          </div>
                      </div>
