        ...
        <div class="col-lg-12">
            ...
            <div class="btn-group" style="margin-right: 20px;">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <form method="post" action="{{action('TagController@destroy', ['tags'=>$tag->id])}}">
                    ...
                    <li>
                        <a href="{{action('TagController@edit', ['tags'=>$tag->id])}}" class="btn btn-link" style="text-align: center;">Edit</a>
                    </li>
                </ul>
            </div>
            @endforeach
